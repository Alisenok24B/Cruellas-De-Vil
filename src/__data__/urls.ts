...
export const URLs = {
  ...
  ui: {
    search:
      getNavigationValue("dog-sitters-finder.search") &&
      `${baseUrl}${getNavigationValue("dog-sitters-finder.search")}`,
    register:
    ...
    dogsitterViewing:
      getNavigationValue("dog-sitters-finder.dogsitter.viewing") &&
      `${baseUrl}${getNavigationValue("dog-sitters-finder.dogsitter.viewing")}`,
  },
  api: {
